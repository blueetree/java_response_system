...
public class ManageUserAccountJPanel extends javax.swing.JPanel {
    ...
    public ManageUserAccountJPanel(JPanel userProcessContainer,UserAccountDirectory ud,UserAccount account,PersonDirectory pd, SupplierDirectory sd) {
        initComponents();
        this.ud=ud;
  ...
  public void populateTable(){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      NewAccountJPanel we = new NewAccountJPanel(userProcessContainer, ud,pd,sd);

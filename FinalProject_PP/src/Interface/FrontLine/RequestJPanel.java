...
public class RequestJPanel extends javax.swing.JPanel {
   ...
   JPanel victimContainer;
    ...
    public RequestJPanel(JPanel victimContainer, UserAccount userAccount, Area area) {
        initComponents();
        ...
        for(Item itemtest:area.getItemDirectory().getItemList()){
            System.out.println("itemtest name: "+ itemtest +" Price:"+itemtest.getPrice()+" Quantity:"+itemtest.getQuantity());
        }
        for(WorkRequest requesttest:area.getWorkQueue().getWorkRequestList()){
            System.out.println("requesttest name: "+ requesttest.getItem().getName() +" Price:"+requesttest.getItem().getPrice()+" Quantity:"+requesttest.getItem().getQuantity());
...
//To change body of generated methods, choose Tools | Templates.
    ...
    private void initComponents() {
        ...
        txtAmont.setFont(new java.awt.Font("Lucida Sans", 0, 13)); // NOI18N
        ...
        ItemName.setFont(new java.awt.Font("Lucida Sans", 0, 13)); // NOI18N

        jLabel11.setFont(new java.awt.Font("Lucida Sans", 0, 13)); // NOI18N
        jLabel11.setText("Price");

        ItemPrice.setFont(new java.awt.Font("Lucida Sans", 0, 13)); // NOI18N
        ...
        cbxItem.setBackground(new java.awt.Color(255, 255, 255));
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(ItemPrice, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (selectedrow >= 0) {
            ...
            area.getWorkQueue().getWorkRequestList().remove(e);
    ...
    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteActionPerformed
        ...
        Iterator<WorkRequest> iterator = area.getWorkQueue().getWorkRequestList().iterator();
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        area.getItemDirectory().createItem(name,Type.Inventory, price);
        //Item item = area.getItemDirectory().createItem(name, price);
        populateItem();
        populateCbxItem();
